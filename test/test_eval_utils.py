...
class TestEvalUtils:
    ...
    def test_calculate_ser_ignores_spaces_and_underscores(self):
        ...
        assert eval_utils.calculate_ser("a b c", "a_b_z") == 1 / 3, 0
    ...
    def test_calculate_ser_wrong_spaces(self):
        ...
        # 10 scored symbols, 1 error, and 1 wrong space. SER should be 0.1, not 0.2.
        assert (
            eval_utils.calculate_ser("hello_world_today", "halloxworld_today") == 0.1
        ), 1

        # 20 scored symbols, 0 errors, and 2 wrong spaces. SER should be 0.0.
        assert (
            eval_utils.calculate_ser(
